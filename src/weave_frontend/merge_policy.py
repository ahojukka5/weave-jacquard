...
class MergePolicyRegistry:
    ...
    def set(
        ...
        *,
        ...
        """Publish one immutable policy revision directly on the selected branch."""
    ...
    def get(
        ...
        *,
        ...
        """Resolve the newest policy on the selected revision's first-parent history."""
    ...
    def compare(
        ...
        """Return target authority and source policy visibility for one merge direction."""
