"""Grammar-neutral persistence and revision mechanics for Weave workspaces."""
...
from .model import JsonObject, MergeResult


class RevisionWorkspace:
    """Immutable project history, branches, snapshots, context, and merge plumbing.

    Language-specific workspaces provide ``_validate_state`` and ``_merge_states``.
    This base deliberately knows nothing about typed ASTs or Weave grammar.
    """
    ...
    def _commit(
        ...
        *,
        ...
        root_hash = self.db.hash_value(state)
