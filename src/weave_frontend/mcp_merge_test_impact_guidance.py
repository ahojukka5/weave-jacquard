...
definitions are virtual and have no committed revision. A complete non-empty
first page emits explicit branch_merge_test_batch_run arguments for the exact
preview; partial and continuation pages emit no execution call. Planning itself
runs nothing and publishes no merge.
""".strip()
