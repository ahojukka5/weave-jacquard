"""Selected merge simulation extended with test-target reference integrity."""
...
from .selected_train import SelectedMergeTrainPreviewService as _Base


class SelectedMergeTrainPreviewService(_Base):
    """Reject virtual merge steps that create dangling behavioral tests."""
